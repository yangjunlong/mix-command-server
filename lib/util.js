 ...
 * check server bin
 * 
 * @param  string bin [path to bin file]
 * @return void
 */
...
/**
 * check server htdocs validity
 * 
 * @param  string htdocs [server document root]
 * @return void
 */
exports.checkHtdocs = function (htdocs) {
    if(htdocs){
 ...
 * @return string
 */
exports.getHtdocs = function() {
    var serverInfo = exports.getServerInfo();
    if (serverInfo['htdocs']) {
        return serverInfo['htdocs'];
    } else {
...
exports.printObject = function(o, prefix) {
    prefix = prefix || '';
    for(var key in o){
        if(o.hasOwnProperty(key)){
            if(typeof o[key] === 'object'){
                exports.printObject(o[key], prefix + key + '.');
            } else {
...
/**
 * set&get server option to&from conf file
 * 
 * @param  object opt 
 * @return object opt
 */
