...
// server internal start method
exports.__start__ = function (opts, callback) {
    // todo 
};
 ...
 * 
 * @return string htdocs
 */
exports.getHtdocs = function () {
    return util.getHtdocs();
};
    ...
    checkJavaEnable(opt, function(java, opt) {
        if (java) {
            checkPHPEnable(opt, function(php, opt) {
                if (php) {
                    var server = fis.require('server', 'jetty');
                    server.start(opt);
                }
            });
        }
