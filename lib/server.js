...
var server = xpage.server = module.exports = new (Object.derive(function(){}, require('./util.js')));
...
server.start = function(opt) {
    ...
    fis.require('server', type).start(opt, function(){
...
// check xpage server process exists
...
server.checkEnable = function(option, callback) {
